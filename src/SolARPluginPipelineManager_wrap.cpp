...
extern "C" 
#endif
SWIGEXPORT void SWIGSTDCALL SWIGRegisterExceptionCallbacks_SolARPipelineManager(
...
extern "C" 
#endif
SWIGEXPORT void SWIGSTDCALL SWIGRegisterExceptionArgumentCallbacks_SolARPipelineManager(
...
extern "C" 
#endif
SWIGEXPORT void SWIGSTDCALL SWIGRegisterStringCallback_SolARPipelineManager(SWIG_CSharpStringHelperCallback callback) {
...
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_Clear(void * jarg1) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; arg1 = (std::vector< std::string > *)jarg1;  { try {
      (arg1)->clear(); }    catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; } 
    catch (...) { { SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_Add(void * jarg1, char * jarg2) {
  ...
  std::string arg2_str(jarg2); arg2 = &arg2_str;  { try { (arg1)->push_back((std::string const &)*arg2); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_SolAR_StringVector_size(void * jarg1) { unsigned long jresult ;
  ...
  arg1 = (std::vector< std::string > *)jarg1;  { try { result = ((std::vector< std::string > const *)arg1)->size(); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (unsigned long)result; 
  return jresult; }
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_SolAR_StringVector_capacity(void * jarg1) { unsigned long jresult ;
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; std::vector< std::string >::size_type result;
  arg1 = (std::vector< std::string > *)jarg1;  { try { result = ((std::vector< std::string > const *)arg1)->capacity(); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (unsigned long)result; 
  return jresult; }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_reserve(void * jarg1, unsigned long jarg2) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; std::vector< std::string >::size_type arg2 ;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (std::vector< std::string >::size_type)jarg2;  { try {
      (arg1)->reserve(arg2); }    catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }
     catch (...) { { SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_new_StringVector__SWIG_0() { void * jresult ;
  std::vector< std::string > *result = 0 ; { try { result = (std::vector< std::string > *)new std::vector< std::string >(); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (void *)result; 
  return jresult; }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_new_StringVector__SWIG_1(void * jarg1) { void * jresult ;
  ...
  if (!arg1) {
    ...
    return 0; }   { try {
      result = (std::vector< std::string > *)new std::vector< std::string >((std::vector< std::string > const &)*arg1); } 
        ...
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (void *)result; 
  return jresult; }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_new_StringVector__SWIG_2(int jarg1) { void * jresult ; int arg1 ;
  std::vector< std::string > *result = 0 ; arg1 = (int)jarg1;  { try { try {
        ...
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (void *)result; 
  return jresult; }
SWIGEXPORT char * SWIGSTDCALL CSharp_SolAR_StringVector_getitemcopy(void * jarg1, int jarg2) { char * jresult ;
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; std::string result;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  { try { try {
...
SWIGEXPORT char * SWIGSTDCALL CSharp_SolAR_StringVector_getitem(void * jarg1, int jarg2) { char * jresult ;
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ;
  std::vector< std::string >::value_type *result = 0 ; arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  { try {
      try { result = (std::vector< std::string >::value_type *) &std_vector_Sl_std_string_Sg__getitem(arg1,arg2);}
       catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return 0; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    } 
  jresult = SWIG_csharp_string_callback(result->c_str());  return jresult; }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_setitem(void * jarg1, int jarg2, char * jarg3) {
  ...
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  if (!jarg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return ; } 
  std::string arg3_str(jarg3); arg3 = &arg3_str;  { try { try {
...
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_AddRange(void * jarg1, void * jarg2) {
  ...
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (std::vector< std::string > *)jarg2; if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< std::string > const & type is null", 0);
    return ; }   { try { std_vector_Sl_std_string_Sg__AddRange(arg1,(std::vector< std::string > const &)*arg2); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_StringVector_GetRange(void * jarg1, int jarg2, int jarg3) { void * jresult ;
  ...
  { try { try { result = (std::vector< std::string > *)std_vector_Sl_std_string_Sg__GetRange(arg1,arg2,arg3);}
       catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return 0; }
       catch(std::invalid_argument &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentException, (&_e)->what(), ""); return 0; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (void *)result; 
  return jresult; }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_Insert(void * jarg1, int jarg2, char * jarg3) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; std::string *arg3 = 0 ;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  if (!jarg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return ; } 
  std::string arg3_str(jarg3); arg3 = &arg3_str;  { try { try {
...
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_InsertRange(void * jarg1, int jarg2, void * jarg3) {
  ...
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  arg3 = (std::vector< std::string > *)jarg3; if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< std::string > const & type is null", 0);
    return ; }   { try { try { std_vector_Sl_std_string_Sg__InsertRange(arg1,arg2,(std::vector< std::string > const &)*arg3);}
       catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return ; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_RemoveAt(void * jarg1, int jarg2) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; arg1 = (std::vector< std::string > *)jarg1; 
  arg2 = (int)jarg2;  { try { try { std_vector_Sl_std_string_Sg__RemoveAt(arg1,arg2);}  catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return ; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_RemoveRange(void * jarg1, int jarg2, int jarg3) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; int arg3 ;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  arg3 = (int)jarg3;  { try { try {
        std_vector_Sl_std_string_Sg__RemoveRange(arg1,arg2,arg3);}  catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return ; }
       catch(std::invalid_argument &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentException, (&_e)->what(), ""); return ; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_StringVector_Repeat(char * jarg1, int jarg2) { void * jresult ;
  std::string *arg1 = 0 ; int arg2 ; std::vector< std::string > *result = 0 ; if (!jarg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return 0; } 
  std::string arg1_str(jarg1); arg1 = &arg1_str;  arg2 = (int)jarg2;  { try { try {
...
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_Reverse__SWIG_0(void * jarg1) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; arg1 = (std::vector< std::string > *)jarg1;  { try {
      std_vector_Sl_std_string_Sg__Reverse__SWIG_0(arg1); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_Reverse__SWIG_1(void * jarg1, int jarg2, int jarg3) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; int arg3 ;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  arg3 = (int)jarg3;  { try { try {
        ...
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_StringVector_SetRange(void * jarg1, int jarg2, void * jarg3) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; int arg2 ; std::vector< std::string > *arg3 = 0 ;
  arg1 = (std::vector< std::string > *)jarg1;  arg2 = (int)jarg2;  arg3 = (std::vector< std::string > *)jarg3; if (!arg3) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::vector< std::string > const & type is null", 0);
    return ; }   { try { try { std_vector_Sl_std_string_Sg__SetRange(arg1,arg2,(std::vector< std::string > const &)*arg3);}
       catch(std::out_of_range &_e) {
        SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentOutOfRangeException, 0, (&_e)->what()); return ; }  } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_SolAR_StringVector_Contains(void * jarg1, char * jarg2) { unsigned int jresult ;
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; std::string *arg2 = 0 ; bool result;
  arg1 = (std::vector< std::string > *)jarg1;  if (!jarg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return 0; } 
  std::string arg2_str(jarg2); arg2 = &arg2_str;  { try {
      result = (bool)std_vector_Sl_std_string_Sg__Contains(arg1,(std::string const &)*arg2); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_StringVector_IndexOf(void * jarg1, char * jarg2) { int jresult ;
  ...
  arg1 = (std::vector< std::string > *)jarg1;  if (!jarg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return 0; } 
  std::string arg2_str(jarg2); arg2 = &arg2_str;  { try {
      result = (int)std_vector_Sl_std_string_Sg__IndexOf(arg1,(std::string const &)*arg2); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_StringVector_LastIndexOf(void * jarg1, char * jarg2) { int jresult ;
  ...
  arg1 = (std::vector< std::string > *)jarg1;  if (!jarg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return 0; } 
  std::string arg2_str(jarg2); arg2 = &arg2_str;  { try {
      result = (int)std_vector_Sl_std_string_Sg__LastIndexOf(arg1,(std::string const &)*arg2); }    catch (std::exception& e) {
      { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_SolAR_StringVector_Remove(void * jarg1, char * jarg2) { unsigned int jresult ;
  ...
  arg1 = (std::vector< std::string > *)jarg1;  if (!jarg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "null string", 0); return 0; } 
  std::string arg2_str(jarg2); arg2 = &arg2_str;  { try {
      result = (bool)std_vector_Sl_std_string_Sg__Remove(arg1,(std::string const &)*arg2); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_delete_StringVector(void * jarg1) {
  std::vector< std::string > *arg1 = (std::vector< std::string > *) 0 ; arg1 = (std::vector< std::string > *)jarg1;  { try {
      delete arg1; }    catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; } 
    catch (...) { { SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_new_SolARPluginPipelineManager() { void * jresult ;
  SolAR::PIPELINE::SolARPluginPipelineManager *result = 0 ; { try {
...
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_delete_SolARPluginPipelineManager(void * jarg1) {
  ...
  arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  { try { delete arg1; }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return ; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_init(void * jarg1, char * jarg2, char * jarg3) {
  ...
  std::string arg3_str(jarg3); arg3 = &arg3_str;  { try {
      result = (bool)(arg1)->init((std::string const &)*arg2,(std::string const &)*arg3); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT void * SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_getCameraParameters(void * jarg1) { void * jresult ;
  SolAR::PIPELINE::SolARPluginPipelineManager *arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *) 0 ;
  SolAR::datastructure::CameraParameters result; arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  { try {
      result = (arg1)->getCameraParameters(); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    } 
  jresult = new SolAR::datastructure::CameraParameters((const SolAR::datastructure::CameraParameters &)result); 
  return jresult; }
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_start(void * jarg1, void * jarg2) {
  ...
  void *arg2 = (void *) 0 ; bool result; arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  arg2 = (void *)jarg2;  {
    try { result = (bool)(arg1)->start(arg2); }    catch (std::exception& e) { {
        SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_udpate(void * jarg1, void * jarg2) { int jresult ;
  SolAR::PIPELINE::SolARPluginPipelineManager *arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *) 0 ;
  SolAR::datastructure::Transform3Df *arg2 = 0 ; SolAR::PIPELINE::PIPELINEMANAGER_RETURNCODE result;
  arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1; 
  arg2 = (SolAR::datastructure::Transform3Df *)(((boost::shared_ptr<  Eigen::Transform<float,3,Eigen::Projective,Eigen::RowMajor> > *)jarg2) ? ((boost::shared_ptr<  Eigen::Transform<float,3,Eigen::Projective,Eigen::RowMajor> > *)jarg2)->get() : 0);
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "SolAR::datastructure::Transform3Df & reference is null", 0);
    return 0; }   { try { result = (SolAR::PIPELINE::PIPELINEMANAGER_RETURNCODE)(arg1)->udpate(*arg2); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (int)result; 
  return jresult; }
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_loadSourceImage(void * jarg1, void * jarg2, int jarg3, int jarg4) {
  ...
  arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  arg2 = (void *)jarg2;  arg3 = (int)jarg3;  arg4 = (int)jarg4;  {
    try { result = (SolAR::PIPELINE::PIPELINEMANAGER_RETURNCODE)(arg1)->loadSourceImage(arg2,arg3,arg4); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = (int)result; 
  return jresult; }
SWIGEXPORT void SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_udpatePose(void * jarg1, void * jarg2) {
  SolAR::PIPELINE::SolARPluginPipelineManager *arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *) 0 ;
  void *arg2 = (void *) 0 ; arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  arg2 = (void *)jarg2;  { try {
      (arg1)->udpatePose(arg2); }    catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return ; }
      ; }  catch (...) { { SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return ; } ; }    }  }
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_stop(void * jarg1) { unsigned int jresult ;
  ...
  arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  { try { result = (bool)(arg1)->stop(); } 
      catch (std::exception& e) { { SWIG_CSharpException(SWIG_SystemError, e.what()); return 0; } ; }  catch (...) { {
        SWIG_CSharpException(SWIG_UnknownError, "unknown exception"); return 0; } ; }    }  jresult = result;  return jresult; }
#ifdef __cplusplus
}
