...
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_udpate(void * jarg1, void * jarg2) { int jresult ;
  ...
  arg1 = (SolAR::PIPELINE::SolARPluginPipelineManager *)jarg1;  arg2 = (SolAR::datastructure::Transform3Df *)jarg2; if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "SolAR::datastructure::Transform3Df & type is null", 0);
