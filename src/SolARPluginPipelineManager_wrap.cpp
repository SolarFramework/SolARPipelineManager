...
SWIGEXPORT int SWIGSTDCALL CSharp_SolAR_SolARPluginPipelineManager_udpate(void * jarg1, void * jarg2) { int jresult ;
  ...
  arg2 = (SolAR::datastructure::Transform3Df *)(((boost::shared_ptr<  Eigen::Transform<float,3,Eigen::Affine,Eigen::RowMajor> > *)jarg2) ? ((boost::shared_ptr<  Eigen::Transform<float,3,Eigen::Affine,Eigen::RowMajor> > *)jarg2)->get() : 0);
  if (!arg2) {
